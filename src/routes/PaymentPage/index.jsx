        ...
        <>
                ...
                <div className="flex flex-col px-6 py-4">
                    ...
                    >
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="17" height="18" viewBox="0 0 17 18" fill="none">
                                <path d="M11.9007 13.25C12.6941 13.25 13.0908 13.25 13.3938 13.0956C13.6604 12.9598 13.8771 12.7431 14.0129 12.4765C14.1673 12.1735 14.1673 11.7768 14.1673 10.9834V4.18335C14.1673 3.38995 14.1673 2.99324 14.0129 2.6902C13.8771 2.42364 13.6604 2.20692 13.3938 2.07109C13.0908 1.91669 12.6941 1.91669 11.9007 1.91669H7.93398C7.14058 1.91669 6.74387 1.91669 6.44083 2.07109C6.17427 2.20692 5.95755 2.42364 5.82173 2.6902C5.66732 2.99324 5.66732 3.38995 5.66732 4.18335M5.10065 16.0834H9.06732C9.86073 16.0834 10.2574 16.0834 10.5605 15.9289C10.827 15.7931 11.0438 15.5764 11.1796 15.3098C11.334 15.0068 11.334 14.6101 11.334 13.8167V7.01669C11.334 6.22328 11.334 5.82658 11.1796 5.52353C11.0438 5.25697 10.827 5.04025 10.5605 4.90443C10.2574 4.75002 9.86073 4.75002 9.06732 4.75002H5.10065C4.30724 4.75002 3.91054 4.75002 3.6075 4.90443C3.34093 5.04025 3.12421 5.25697 2.98839 5.52353C2.83398 5.82658 2.83398 6.22328 2.83398 7.01669V13.8167C2.83398 14.6101 2.83398 15.0068 2.98839 15.3098C3.12421 15.5764 3.34093 15.7931 3.6075 15.9289C3.91054 16.0834 4.30724 16.0834 5.10065 16.0834Z" stroke="white" stroke-width="0.85"/>
                            </svg>
                        </div> <div
                ...
                {file &&
                    <div className="flex px-6 py-3">
                        <div className="flex w-full justify-between bg-[#EFEEFF] px-6 py-[11px] rounded-[7px]">
                            ...
                            <div className="text-[#5755FF] cursor-pointer" onClick={handleFileChange}>Изменить</div>
                        </div>
                    </div>
                }
            </div>
            ...
            <div
                ...
                <div className="pb-4 flex justify-between items-center">
                    <span className="text-sm">8 товаров</span>
                    <span
                        className="text-[19px] text-[#5755FF] font-semibold">
                        2000 ₸
                    </span>
                </div>
                <button className="p-4 bg-[#5755FF] text-white w-full rounded-2xl" disabled={file !== null}>
                    Подтвердить
                </button>
            </div>
        </>
